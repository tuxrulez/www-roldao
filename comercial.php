...
<?php
/**
 * comercial.php: Cadastra no banco de dados todos os arquivos comerciais
...
$result = mysql_query("SELECT tipo FROM tipos WHERE tipo='comercial'");		// comercial
...
$result = mysql_query("SELECT tipo,genero FROM generos WHERE tipo='comercial'");	// varre todos os generos comerciais
